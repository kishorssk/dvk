...
<head>
    ...
    <link rel="stylesheet" href="<?=PUBLIC_URL?>css/navbar.css?v=4.0">
    <link rel="stylesheet" href="<?=PUBLIC_URL?>css/homepage.css?v=5.0">
    <link rel="stylesheet" href="<?=PUBLIC_URL?>css/fonts.css?v=4.0">
...
<body>
    ...
    <nav id="mainNavBar" class="navbar navbar-light navbar-expand-lg fixed-top">
        <div class="container-fluid clear-paddings">
            ...
            <p class="navbar-text" id="navbarText"><!-- <small>ಪ್ರೊಫೆಸರ್</small><br /> -->ಡಿ.ವಿ.ಕೆ. ಮೂರ್ತಿ ಪ್ರಕಾಶನ</p>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav nav ml-auto">
                    ...
                    <li><a href="javascript:void();">◦</a></li>
                    <li><a href="<?=BASE_URL?>About">ಡಿ.ವಿ.ಕೆ ಕುರಿತು</a></li>
                    <li><a href="javascript:void();">◦</a></li>
